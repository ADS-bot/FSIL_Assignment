...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/ADS-bot/FSIL_Assignment.git
   cd FSILassignment
...
Explore the live demo of the app [here](https://fsilassignment-9wuzvt9ra9yn9cywoetncs.streamlit.app/).
...
Have thoughts to share or encounters to recount? Venture forth and let us know your tales [here](https://github.com/ADS-bot/FSIL_Assignment/issues).